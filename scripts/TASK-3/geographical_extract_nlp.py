...
def main(data_file_path):
    ...
    top_5_locations = create_folium_heatmap(geocoded_locations, output_file="crisis_heatmap_nlp_geoExtracted.html")
    top_locations_df = create_plotly_heatmap(geocoded_locations, processed_df, output_file="crisis_plotly_map.html")
